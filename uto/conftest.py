...
def login(driver, username: str, password: str):
    ...
    WebDriverWait(driver, 10).until(
        EC.presence_of_element_located((By.XPATH, "//a[@class='aside-logo']//h2[@class='text-white'][normalize-space()='AmaderHR']"))
    )
    # assert "AmaderHR" in driver.title, "Login failed: title mismatch"
